...
Процедура ПерерасчитатьНаСервере()
	...
	Для каждого НаборЗаписей Из ДокументОбъект.Движения Цикл
		...
		Если ИмяРегистра = "ОсновныеНачисления" Тогда
			...
			ОбщийМодульРасчетРесурсов.ПереРассчитатьРесурсы_Начисления(НаборЗаписей);
			
		ИначеЕсли ИмяРегистра = "ДополнительныеНачисления" Тогда
			
			ОбщийМодульРасчетРесурсов.ПереРассчитатьРесурсы_ДополнительныеНачисления(НаборЗаписей);
			
		ИначеЕсли ИмяРегистра = "Удержания" Тогда
			
			ОбщийМодульРасчетРесурсов.ПереРассчитатьРесурсы_Удержания(НаборЗаписей);
