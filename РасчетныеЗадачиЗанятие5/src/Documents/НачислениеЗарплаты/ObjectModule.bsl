...
//	ОбщийМодульРасчетРесурсов.ПереРассчитатьРесурсы_ДополнительныеНачисления(Движения.ДополнительныеНачисления);
...
Процедура РасчетРесурсов(ВыборкаДетальныеЗаписи, Выборка_ДанныеГрафика_База, Запись)
	...
	//3	Устаревший
	ИначеЕсли ВыборкаДетальныеЗаписи.СпособРасчета = Перечисления.СпособыРасчета.ПоМесячнойТарифнойСтавкеПоДням Тогда
...
Процедура ЗаполнитьНаборЗаписей_ДополнительныеНачисления(Режим)
	...
	Для Каждого ТекСтрокаДополнительныеНачисления Из ДополнительныеНачисления Цикл
		...
		Движение.Показатель = ТекСтрокаДополнительныеНачисления.Показатель;
