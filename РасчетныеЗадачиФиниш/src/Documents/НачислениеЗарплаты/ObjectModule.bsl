...
Процедура РассчитатьРесурсы() Экспорт 
	...
	РасчетРесурсовСервер.РассчитатьРесурсы_Удержания(Движения.Удержания);
...
Процедура ПереРассчитатьРесурсы() Экспорт 
	...
	РасчетРесурсовСервер.ПереРассчитатьРесурсы_Начисления(Движения.Начисления);
	РасчетРесурсовСервер.ПереРассчитатьРесурсы_Удержания(Движения.Удержания);
