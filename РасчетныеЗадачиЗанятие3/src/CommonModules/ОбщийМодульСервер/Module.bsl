...
Процедура ПроверитьНаличиеОдногоНачисленияЗачетОтработанногоВремени(Приказ, Отказ) Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ПриказОПриемеНачисления.ВидРасчета
	|ПОМЕСТИТЬ ВТНачисления
	|ИЗ
	|	Документ.ПриказОПриеме.Начисления КАК ПриказОПриемеНачисления
	|Где
	|	Ссылка = &Приказ
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	КОЛИЧЕСТВО(ВТНачисления.ВидРасчета) КАК ВидРасчета
	|ИЗ
	|	ВТНачисления КАК ВТНачисления
	|ГДЕ
	|	ВТНачисления.ВидРасчета.ЗачетОтработанногоВремени = ИСТИНА";
